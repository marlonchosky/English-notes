1. I had the report translated
   - had: CTV
   - the report: DO and NP
   - translated: it can be an adjective, or a Past Participle in the passive voice.
2. I want the mineral samples tested
   - want: CTV
   - the mineral samples: DO and NP
     - the: central determiner
     - mineral: Noun adjunct
     - samples: head word
   - tested: it can be an adjective or a Past Participle in Passive Voice
3. The manager wants the project finished
   - wants: CTV
